...
*/}}
{{- define "agentops.memory.serviceName" -}}
{{- printf "%s-memory" (include "agentops.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Memory in-cluster URL — resolved from the service name and agent namespace.
*/}}
{{- define "agentops.memory.url" -}}
{{- printf "http://%s.%s.svc.cluster.local:7437" (include "agentops.memory.serviceName" .) .Values.agentNamespace }}
{{- end }}

{{/*
Tempo in-cluster URL — resolved from the release name.
*/}}
{{- define "agentops.tempo.url" -}}
...
*/}}
{{- define "agentops.tempo.otlpEndpoint" -}}
